...
public class NewOrder extends MyBrowsers {

	public static void startNewOrder() {
		driver.findElement(By.linkText("Order")).click();
		enterOrderDetails("FamilyAlbum", "2", "23.5", "Parker Jonhson", "Qara Qarayev", "Houston", "Texas", "77055", "Visa", "4400112233445566", "11/22");
		driver.findElement(By.id("ctl00_MainContent_fmwOrder_InsertButton")).click();
		driver.findElement(By.linkText("View all orders")).click();
	}

	public static void enterOrderDetails(String product, String quantity,
